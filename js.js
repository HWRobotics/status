      ...
      for (i = 0; i < jd.length; i++) {
        if (jd[i].alliances.red.teams[0] == 'frc'+teamNumber || jd[i].alliances.red.teams[1] == 'frc'+teamNumber || jd[i].alliances.red.teams[2] == 'frc'+teamNumber || jd[i].alliances.blue.teams[0] == 'frc'+teamNumber || jd[i].alliances.blue.teams[1] == 'frc'+teamNumber || jd[i].alliances.blue.teams[2] == 'frc'+teamNumber) {
          if (jd[i].alliances.blue.score == -1) {
            ...
            $('#status').append('<br><div style="color:red;">' + jd[i].alliances.red.teams[0].substring(3) + ", " + jd[i].alliances.red.teams[1].substring(3) + ", " + jd[i].alliances.red.teams[2].substring(3));
            $('#status').append('</div><div style="color:blue;">' + jd[i].alliances.blue.teams[0].substring(3) + ", " + jd[i].alliances.blue.teams[1].substring(3) + ", " +jd[i].alliances.blue.teams[2].substring(3));
            $('#status').append('</div>');
            break;
          }
        }
  ...
  $.ajax({
    ...
    success: function(jd) {
      ...
      for (i = jd.length-1; i >= 0; i--) {
        if (jd[i].alliances.red.score != -1 && i+1!=jd.length) {
